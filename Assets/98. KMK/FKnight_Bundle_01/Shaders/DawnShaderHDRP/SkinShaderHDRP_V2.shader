	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Albedo = clampResult197.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode63 = tex2D( _Dirt, uv_Dirt );
				float4 lerpResult70 = lerp( lerpResult140 , ( _DirtColor * _DirtBoots ) , ( _DirtBoots * tex2DNode63.r ));
				float2 uv_TattoMask = packedInput.ase_texcoord.xy * _TattoMask_ST.xy + _TattoMask_ST.zw;
				float4 lerpResult195 = lerp( lerpResult70 , _TattooColor , ( tex2D( _TattoMask, uv_TattoMask ).r * _TattooBoots ));
				float4 clampResult197 = clamp( lerpResult195 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode63 = tex2D( _Dirt, uv_Dirt );
				float4 lerpResult70 = lerp( lerpResult140 , ( _DirtColor * _DirtBoots ) , ( _DirtBoots * tex2DNode63.r ));
				float2 uv_TattoMask = packedInput.ase_texcoord7.xy * _TattoMask_ST.xy + _TattoMask_ST.zw;
				float4 lerpResult195 = lerp( lerpResult70 , _TattooColor , ( tex2D( _TattoMask, uv_TattoMask ).r * _TattooBoots ));
				float4 clampResult197 = clamp( lerpResult195 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
...
/*ASEBEGIN
Version=18801
2560;6;2560;1013;2369.152;2508.286;2.14986;True;True
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;66;-864.1537,-1413.515;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=543BFDE39C33D5B43BF189767212953BCB6DA143